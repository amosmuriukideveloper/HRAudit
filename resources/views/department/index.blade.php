<x-app-layout>
    ...
    <div class="row">
        ...
        <div class="card-title">
            ...
            <a href="{{ route('department.create') }}" class="btn btn-outline-primary btn-sm float-right" data-toggle="modal" data-target="#addDepartment"><i class="mdi mdi mdi-plus-circle-outline"></i>Add Department</a>


        </div>

        <div class="modal fade" id="addDepartment" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable">
                <form method="POST" action="{{ route('department.store') }}">
                    @csrf
                <div class="modal-content" style="min-width: 400px">
                    <div class="modal-header header-title">
                        <h5 class="modal-title mt-0" id="addDepartment">Add Department</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-sm btn-outline-primary"><i class="mdi mdi-checkbox-marked-circle-outline"></i>Add Department</button>
                        </div>
                </div><!-- /.modal-content -->
                </form>
            </div><!-- /.modal-dialog -->
        ...
        <div class="row">
            ...
            <tr>
                ...
                <td><a href="{{ route('department.edit', $department->id) }}" ><i class="mdi mdi-playlist-edit " style="font-size: 20px"></i></a></td>
                <td>
