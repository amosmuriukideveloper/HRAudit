<x-app-layout>
    ...
    <div class="row">
        ...
        <div class="card-title">
            ...
            <a href="{{ route('certificate.create') }}" class="btn btn-outline-primary btn-sm float-right" data-toggle="modal" data-target="#addCertificate"><i class="mdi mdi mdi-plus-circle-outline"></i>Add Certificate</a>


        </div>

        <div class="modal fade" id="addCertificate" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable">
                <form method="POST" action="{{ route('certificate.store') }}">
                    @csrf
                <div class="modal-content" style="min-width: 400px">
                    <div class="modal-header header-title">
                        <h5 class="modal-title mt-0" id="addCertificate">Add certificate</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-sm btn-outline-primary"><i class="mdi mdi-checkbox-marked-circle-outline"></i>Add Certificate</button>
                        </div>
                </div><!-- /.modal-content -->
                </form>
            </div><!-- /.modal-dialog -->
        ...
        <div class="row">
            ...
            <tr>
                ...
                <td><a href="{{ route('certificate.edit', $certificate->id) }}" ><i class="mdi mdi-playlist-edit " style="font-size: 20px"></i></a></td>
                <td>
